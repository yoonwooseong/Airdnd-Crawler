...
def check_room_idx_in_DB(): 
    sql_select = 'select home_idx from airdnd_home2'
...
def insert_room_data_in_MysqlDB(data):
    print(data['room_idx'])
    #DB에 접근하기 위한 쿼리문
    sql_insert =  'insert into airdnd_home2 (home_idx, place, title, isSuperHost, addr, lat, lng, sub_title, filter_max_person, filter_bedroom, filter_bed, filter_bathroom, price, host_notice, loc_info) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_picture(room_idx, room_picture):
    sql_insert =  'insert into airdnd_home_picture2 (idx, home_idx, url) VALUES (0, %s, %s)'
...
def insert_room_data_in_airdnd_home_notice(room_idx, room_notice_sort, room_notice_content, room_notice_icon):
    sql_insert =  'insert into airdnd_home_notice2 (idx, home_idx, home_notice_sort, home_notice_content, home_notice_icon) VALUES (0, %s, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_bed(room_idx, bed_room_name, bed_room_option, icon_str):
    sql_insert =  'insert into airdnd_home_bed2 (idx, home_idx, bed_room_name, bed_room_option, bed_icons) VALUES (0, %s, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_convenient_facility(room_idx, convenient_facilitiy, room_convenient_facility_icon):
    sql_insert =  'insert into airdnd_home_convenient_facility2 (idx, home_idx, facility, facility_icon) VALUES (0, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_review(room_idx, review_dic):
    sql_insert =  'insert into airdnd_home_review2 (idx, home_idx, user_name, review_date, review_content, room_cleanliness, room_accuracy, room_communication, room_position, room_checkin, room_cost_effectiveness) VALUES (0, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_attractions_distance(room_idx, attractions):
    sql_insert =  'insert into airdnd_home_attractions_distance2 (idx, home_idx, attractions_name, attractions_distance) VALUES (0, %s, %s, %s)'
...
def insert_room_data_in_airdnd_home_use_rule(room_idx, use_rule):
    sql_insert =  'insert into airdnd_home_use_rule2 (idx, home_idx, use_rule) VALUES (0, %s, %s)'
...
def insert_room_data_in_airdnd_home_safety_rule(room_idx, safety):
    sql_insert =  'insert into airdnd_home_safety_rule2 (idx, home_idx, safety_rule) VALUES (0, %s, %s)'
    val = (room_idx, safety)
    db.execute(sql_insert, val)
    conn.commit()
...
def insert_room_data_in_airdnd_host(room_idx, host_data):
    sql_insert =  'insert into airdnd_host2 (idx, home_idx, host_name, host_sign_in_date, check_superhost, check_certification, host_review_num, host_status_message, Interaction_with_guests, host_language, response_rate, response_time) VALUES (0, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
